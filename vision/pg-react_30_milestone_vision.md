...
> Planning status (August 2026): M43 is complete, extension `0.40.0` is the current qualified baseline, and M44 is the next candidate. `1.0.0` and its complete feature freeze are postponed indefinitely. [`ROADMAP.md`](../ROADMAP.md) remains the canonical milestone schedule.
