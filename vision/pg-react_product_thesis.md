...
> Current state: M40 and extension `0.37.0` are the qualified baseline. M41 end-to-end causal paths is the current planning milestone and targets extension `0.38.0`. The repository retains the prepared `1.0.0-rc.1` candidate, but `1.0.0` and its complete feature freeze are postponed indefinitely. The [documentation home](../docs/index.md) and [support matrix](../docs/v1-support-matrix.md) define the current product contract.
