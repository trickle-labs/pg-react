...
The candidate is `candidate_owner_signed`. Contract v4 records the owner sign-off for the repaired snapshot and waives independent review for this solo-maintainer release; the manifest and qualification artifacts remain bound to the exact fingerprint above.
