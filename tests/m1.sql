...
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA pgreact TO m1_author;
GRANT SELECT ON ALL TABLES IN SCHEMA pgreact TO m1_author;
GRANT EXECUTE ON FUNCTION pgreact.pause_rule(uuid) TO m1_intruder;
GRANT SELECT ON pgreact.rules TO m1_intruder;
