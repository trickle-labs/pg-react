...
current_files=(
  ...
  docs/benchmarks.md docs/v0.46.0-release-notes.md docs/v0.46.0-migration.md
)
...
for file in README.md ROADMAP.md docs/index.md docs/getting-started.md docs/installation.md \
  ...
  docs/product-contract.md docs/benchmarks.md docs/v0.46.0-release-notes.md; do
  ! grep -Fq '1.0.0-rc.1' "$file"
done

grep -Fq 'v0.46.0-release-notes.md' docs/history.md
grep -Fq 'v0.46.0-migration.md' docs/history.md
echo 'v0.46.0 current-release audit passed'
