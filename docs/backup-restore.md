...
The current release is pg-react `0.44.0`. Back up the PostgreSQL database and
...
For a rollback from `0.44.0`, restore a verified `0.43.3` backup and install
the matching `0.43.3` artifact. Do not mix extension SQL, container versions,
