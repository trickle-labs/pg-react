...
The current release is pg-react `0.43.2`. Back up the PostgreSQL database and
...
For a rollback from `0.43.2`, restore a verified `0.43.1` backup and install
the matching `0.43.1` artifact. Do not mix extension SQL, container versions,
