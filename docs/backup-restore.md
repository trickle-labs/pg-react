...
The current release is pg-react `0.43.3`. Back up the PostgreSQL database and
...
For a rollback from `0.43.3`, restore a verified `0.43.2` backup and install
the matching `0.43.2` artifact. Do not mix extension SQL, container versions,
