...
The current release is pg-react `0.43.1`. Back up the PostgreSQL database and
...
For a rollback from `0.43.1`, restore a verified `0.43.0` backup and install
the matching `0.43.0` artifact. Do not mix extension SQL, container versions,
