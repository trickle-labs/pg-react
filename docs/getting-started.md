...
pg-react `0.45.0` environment from [Installation](installation.md):
PostgreSQL 18.4, pg_trickle 0.98.0, Linux
...
Expect pg-react `0.45.0`, pg_trickle `0.98.0`, a doctor state of `ready`, and a
