...
pg-react `0.46.0` environment from [Installation](installation.md):
PostgreSQL 18.3, pg_trickle 0.108.0, Linux
...
Expect pg-react `0.46.0`, pg_trickle `0.108.0`, a doctor state of `ready`, and a
