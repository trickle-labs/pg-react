...
- M0-M30 records preserve the incremental delivery history under `docs/m*-*`.
- [M31 release notes](m31-release-notes.md) preserve the authoritative-runtime
  predecessor milestone.
- [M32 API reference](m32-api-reference.md) preserves the PostgreSQL-native
  interface milestone.
- [M33 release notes](m33-release-notes.md) preserve the `0.30.0`
...
- The old [`v1-release-notes.md`](v1-release-notes.md) and
  [`v1-upgrades.md`](v1-upgrades.md) preserve the historical M4 `0.1.1`
  release.

## Qualification evidence

- [M33 evidence](m33-evidence.md), [readiness](m33-readiness.md), and
