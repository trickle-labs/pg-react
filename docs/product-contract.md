...
pg-react `0.45.0` keeps PostgreSQL authoritative for application facts,
...
Version 0.45.0 qualifies pg_trickle 0.98.0 with trigger CDC, explicit refresh
coordination, and the scheduler disabled. Graph V1 and Delta V1 remain
experimental and disabled. The release adds no new evaluator or policy
semantics.
