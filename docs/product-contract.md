...
Version 0.46.0 qualifies pg_trickle 0.108.0 with trigger CDC, explicit refresh
coordination, and the scheduler disabled. Stable Graph V1.2 and Delta V1.1 are
