...
| pg-react artifact | `1.0.0-rc.1` candidate OCI image and extension files (with `0.31.0` feature baseline and qualified upgrade `0.31.0 -> 1.0.0-rc.1`) | Releases before `0.31.0`; unreleased or untracked candidate versions |
...
The 1.0.0-rc.1 extension is built with pgrx 0.18.0 and Rust 1.89.0. These identify
...
- The managed runtime dynamically accepts `0.31.0`, `1.0.0-rc.N`, and `1.0.0`
  extension versions.
- In `1.0.0-rc.1`, `pgreact_api.configure_roles(...)` authoritatively configures
